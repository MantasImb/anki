# V2 Rollout Checklist

This is a temporary operational document. Delete it after the v2 database reset and rollout verification are complete.
...
- [ ] Verify that the Default Generation Template is available as the initial Generation Instructions.
- [ ] Verify that no pre-existing Flashcard Deck, Quiz, learning content, or progress remains.
- [ ] Verify that the Learner can create the first Flashcard Deck and first Quiz manually.
- [ ] Delete this completed checklist.
