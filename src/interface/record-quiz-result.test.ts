...
describe("Quiz answer submission", () => {
  it("records every selected option and returns all correct options for feedback", async () => {
    const recordResult = vi.fn(async (input) => ({
      ...
      correctOptionIds: [
        ...
        "2acb88e5-a372-4315-a1ac-48c0cc4c4d82",
      ],
    }));
    ...
    formData.append("selectedOptionIds", "bf56aef6-a583-42cb-af8a-d21a4d2a2165");
    formData.append("selectedOptionIds", "2acb88e5-a372-4315-a1ac-48c0cc4c4d82");
    ...
    expect(feedback.correctOptionIds).toEqual([
      "bf56aef6-a583-42cb-af8a-d21a4d2a2165",
      "2acb88e5-a372-4315-a1ac-48c0cc4c4d82",
    ]);
  });
  ...
  it("records the selected option and returns automatic Answer Feedback", async () => {
    ...
    formData.set("attemptId", "8de9e5d4-2788-47af-8767-d1a4b6a1b0fd");
    formData.set("questionId", "420d7e63-b4e4-4f5c-b88d-93ab42add48a");
    formData.set("selectedOptionIds", "bf56aef6-a583-42cb-af8a-d21a4d2a2165");
    formData.set("translationHelpUsed", "false");
